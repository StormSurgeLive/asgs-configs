...
INSTANCENAME=SFLv111-gfs    # "name" of this ASGS process

# Initial state (overridden by STATEFILE after ASGS gets going)

HINDCASTLENGTH=20
COLDSTARTDATE=2022121800
HOTORCOLD=coldstart
...
POSTPROCESS=( includeWind10m.sh createMaxCSV.sh createOPeNDAPFileList.sh $OPENDAPPOST )
