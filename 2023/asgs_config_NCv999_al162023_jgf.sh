...
INSTANCENAME=NCv999_al162023_jgf # "name" of this ASGS process
...
COLDSTARTDATE=auto
HOTORCOLD=hotstart
LASTSUBDIR=http://chg-1.oden.tacc.utexas.edu/thredds/fileServer/asgs/2023/nam/2023092106/NCv999/frontera.tacc.utexas.edu/NCv999_nam_jgf/namforecast
