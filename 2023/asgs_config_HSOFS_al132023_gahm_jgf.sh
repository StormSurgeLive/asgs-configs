...
INSTANCENAME=HSOFS_al132023_gahm_jgf   # "name" of this ASGS process
...
LASTSUBDIR=http://chg-1.oden.tacc.utexas.edu/thredds/fileServer/asgs/2023/lee/10/HSOFS/frontera.tacc.utexas.edu/HSOFS_al132023_jgf/nhcConsensus
