#!/usr/bin/env bash
#-- created on 2024-10-05 18:15:51 UTC, https://tools.adcirc.live --#
...
# file:
#   asgs_config_HSOFS_al142024_ls6_be.sh
#-------------------------------------------------------------------
# Instance and Operator Information
#-------------------------------------------------------------------
#

INSTANCENAME=HSOFS_al142024_ls6_be
...
ADCIRCVERSION="v53.05"
   # !! intended ADCIRC version (no impact as of 2024-10-05 18:15:51 UTC)
...
LASTSUBDIR=https://fortytwo.cct.lsu.edu/thredds/fileServer/2024/GFS/2024100506/HSOFS/qbc.loni.org/HSOFS_gfs_qbc_sn/gfsforecast
