...
INSTANCENAME=CPRA23v05b_nam_smic_jgf # "name" of this ASGS process
...
BACKGROUNDMET=on         # GFS download/forcing
   FORECASTCYCLE="06"
...
COLDSTARTDATE=auto
HOTORCOLD=hotstart
LASTSUBDIR=https://fortytwo.cct.lsu.edu/thredds/fileServer/2024/GFS/2024051106/CPRA23v05b/qbc.loni.org/CPRA23v05b_gfs_jgf/nowcast
