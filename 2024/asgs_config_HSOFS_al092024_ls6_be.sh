#!/usr/bin/env bash
#-- created on 2024-09-23 16:33:01 UTC, https://tools.adcirc.live --#
...
# file:
#   asgs_config_HSOFS_al092024_ls6_be.sh
#-------------------------------------------------------------------
# Instance and Operator Information
#-------------------------------------------------------------------
#

INSTANCENAME=HSOFS_al092024_ls6_be
...
ADCIRCVERSION="v53.05"
   # !! intended ADCIRC version (no impact as of 2024-09-23 16:33:01 UTC)
