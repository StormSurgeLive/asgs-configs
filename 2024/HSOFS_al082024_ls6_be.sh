#!/bin/sh
#-- created on 2024-09-15 22:25:48 UTC, https://tools.adcirc.live --#
...
INSTANCENAME=HSOFS_al082024_ls6_be
...
ADCIRCVERSION="v53.05"
   # !! intended ADCIRC version (no impact as of 2024-09-15 22:25:48 UTC)
