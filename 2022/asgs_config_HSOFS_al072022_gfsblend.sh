...
INSTANCENAME=HSOFS_al072022_gfsblend  # "name" of this ASGS process
...
BACKGROUNDMET=gfsBlend  # GFS download/forcing
FORECASTCYCLE="06"
...
LASTSUBDIR=http://chg-1.oden.tacc.utexas.edu/thredds/fileServer/asgs/2022/GFS/2022091506/HSOFS/ls6.tacc.utexas.edu/HSOFS_gfs_jgf/gfsforecast
