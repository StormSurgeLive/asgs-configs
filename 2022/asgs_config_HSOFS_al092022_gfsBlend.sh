...
INSTANCENAME=HSOFS_al092022_gfsBlend  # "name" of this ASGS process
...
LASTSUBDIR=http://chg-1.oden.tacc.utexas.edu/thredds/fileServer/asgs/2022/GFS/2022092506/HSOFS/ls6.tacc.utexas.edu/HSOFS_gfs_jgf/nowcast
