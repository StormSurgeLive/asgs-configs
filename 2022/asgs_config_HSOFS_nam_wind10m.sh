...
INSTANCENAME=HSOFS_nam_wind10m  # "name" of this ASGS process
...
LASTSUBDIR=http://chg-1.oden.tacc.utexas.edu/thredds/fileServer/asgs/2022/GFS/2022090306/HSOFS/ls6.tacc.utexas.edu/HSOFS_gfs_jgf/gfsforecast
