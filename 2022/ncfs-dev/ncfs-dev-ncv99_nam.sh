...
INSTANCENAME=ncv99-nam-bob-2022      # "name" of this ASGS process
SCRATCHDIR=/projects/ncfs-dev/${INSTANCENAME}
RMQMessaging_Transmit=on
#QSCRIPTTEMPLATE=$SCRIPTDIR/asgs-configs/2022/ncfs-dev/qscript.template.renci
...
COLDSTARTDATE=2022010100  #  2020080100  # calendar year month day hour YYYYMMDDHH24
