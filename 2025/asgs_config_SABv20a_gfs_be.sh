#!/usr/bin/env bash
#-- created on 2025-08-31 01:24:33 UTC, https://tools.adcirc.live --#
...
# file:
#   asgs_config_SABv20a_GFS_frontera_be.sh
#-------------------------------------------------------------------
# Instance and Operator Information
#-------------------------------------------------------------------
#

INSTANCENAME=SABv20a_GFS_frontera_be
   # !! "name" of this ASGS process
ASGSADMIN=asgsnotify@memenesia.net
   # !! email address of operator, HPCs need it
#ACCOUNT=BCS23006 # NOTE: set in ~/.asgsh_profile on the host machine
...
ADCIRCVERSION="v56.0.4"
   # !! intended ADCIRC version (no impact as of 2025-08-31 01:24:33 UTC)
