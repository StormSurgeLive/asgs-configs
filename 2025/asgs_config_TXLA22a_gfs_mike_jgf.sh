...
INSTANCENAME=TXLA22a_gfs_mike_jgf # "name" of this ASGS process
...
COLDSTARTDATE=auto
HOTORCOLD=hotstart
LASTSUBDIR=https://fortytwo.cct.lsu.edu/thredds/fileServer/2025/GFS/2025090806/TXLA22a/frontera.tacc.utexas.edu/TXLA22a_gfs_frontera_jgf/gfsforecast
