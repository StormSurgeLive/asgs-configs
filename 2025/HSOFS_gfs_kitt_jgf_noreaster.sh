...
INSTANCENAME=HSOFS_gfs_kitt_jgf_noreaster # "name" of this ASGS process
...
COLDSTARTDATE=auto
HOTORCOLD=hotstart
LASTSUBDIR=https://fortytwo.cct.lsu.edu/thredds/fileServer/2025/GFS/2025100800/HSOFS/qbc.loni.org/HSOFS_gfs_qbc_of_015_sn/gfsforecast
