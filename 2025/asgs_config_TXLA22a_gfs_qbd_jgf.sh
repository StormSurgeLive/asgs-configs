...
# file:
#   asgs_config_TXLA22a_NAM_ls6_be.sh
#-------------------------------------------------------------------
# Instance and Operator Information
#-------------------------------------------------------------------
#

INSTANCENAME=TXLA22a_gfs_qbd_jgf
...
#
# ** MOVED ** 
HINDCASTLENGTH=30 #<---<< ** moved to before the call to get-coldstart-date
...
OPENDAPNOTIFY="coastalrisk.live@outlook.com,pub.coastalrisk.live@outlook.com,asgs.cera.lsu@coastalrisk.live,asgs.cera.pub.lsu@coastalrisk.live jason.fleming@stormsurge.live"
...
SCENARIOPACKAGESIZE=1
   # !! NAM only has 1 actual scenarios, not including the hindcast and the nowcast
   # !! the "namforecaseWind10m" step is now rolled into "namforecast" when
