...
INSTANCENAME=LAv20a_al092021blend_retro  # "name" of this ASGS process
...
BACKGROUNDMET=off   
   #HDIR=/work/jgflemin/al092021/2021082218_2021082612
FORECASTCYCLE="06"
...
YEAR=2021            # year of the storm
   ...
   FDIR="/work/jgflemin/asgs/input/sample_advisories/2021/al09"  # forecast dir
   HDIR="/work/jgflemin/asgs/input/sample_advisories/2021/al09"  # BEST dir
...
#PERCENT=default
SCENARIOPACKAGESIZE=0 # <====<<!!TWO TOTAL!! # number of scenarios
case $si in
 -2)
   ENSTORM=hindcast
   ;;
