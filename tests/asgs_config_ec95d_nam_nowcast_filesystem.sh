...
INSTANCENAME=EC95d_nam_nowcast_filesystem   # "op" nickname set in config/operator_defaults.sh
...
BACKGROUNDMET=on      # NAM download/forcing
   BACKSITE=filesystem
   #BACKDIR=~/Campaigns/Development/2023/test-nam-nowcast-with-files/nam
   BACKDIR=/mnt/nas-storage/Data/nam-al092022-ian
...
COLDSTARTDATE=2022073000   # nam-al092022-ian
...
#PERCENT=default
SCENARIOPACKAGESIZE=0 # number of forward looking scenarios
case $si in
-2) 
   ENSTORM=hindcast
   ;;
