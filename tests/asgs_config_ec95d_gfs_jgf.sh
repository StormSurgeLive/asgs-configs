...
INSTANCENAME=EC95d_gfs_jgf   # "op" nickname set in config/operator_defaults.sh
...
LASTSUBDIR=http://tds.renci.org/thredds/fileServer/2022/GFS/2022080500/ec95d/hatteras.renci.org/v54.01-custom-hatteras-ec95d/gfsforecast
