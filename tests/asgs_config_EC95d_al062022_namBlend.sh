...
INSTANCENAME=EC95d_al062022_namBlend
...
BACKGROUNDMET=namBlend # basin scale meteorological forcing
   FORECASTCYCLE="06"
...
POSTPROCESS=( includeWind10m.sh createOPeNDAPFileList.sh )
OPENDAPNOTIFY="null"
hooksScripts[FINISH_SPINUP_SCENARIO]=" output/createOPeNDAPFileList.sh "
hooksScripts[FINISH_NOWCAST_SCENARIO]=" output/createOPeNDAPFileList.sh "
...
COLDSTARTDATE=2022080400
HOTORCOLD=hotstart        # "hotstart" or "coldstart"
LASTSUBDIR=$HOME/scratch/asgs3010911/initialize
