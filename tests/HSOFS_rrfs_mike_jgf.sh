...
INSTANCENAME=HSOFS_rrfs_mike_jgf # "name" of this ASGS process
...
COLDSTARTDATE=auto
HOTORCOLD=hotstart
LASTSUBDIR=https://fortytwo.cct.lsu.edu/thredds/fileServer/2025/GFS/2025101600/HSOFS/qbc.loni.org/HSOFS_gfs_qbc_of_015_sn/gfsforecast
