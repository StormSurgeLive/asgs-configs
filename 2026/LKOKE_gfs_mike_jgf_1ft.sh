...
INSTANCENAME=LKOKE_gfs_mike_jgf_1ft # "name" of this ASGS process
...
# set starting level to +1ft or +0.3048m 
nodal_attribute_default_values["sea_surface_height_above_geoid"]="0.3048"  
...
NCPU=88                  # number of compute CPUs for all simulations
NCPUCAPACITY=9999
NUMWRITERS=0
...
POSTPROCESS=( vispipe_post.sh asgs_post.sh )
