#!/usr/bin/env bash
#-- created on 2024-11-04 17:41:30 UTC, https://tools.adcirc.live --#
...
# file:
#   asgs_config_TXLA22a_GFS_frontera_be.sh
#-------------------------------------------------------------------
# Instance and Operator Information
#-------------------------------------------------------------------
#

INSTANCENAME=TXLA22a_GFS_frontera_be
   # !! "gfse" of this ASGS process
...
ADCIRCVERSION="v55.01*"
   # !! intended ADCIRC version (no impact as of 2024-11-04 17:41:30 UTC)
...
# Meteorological (winds - GFS, GFS, etc)
BACKGROUNDMET=on
...
PREPPEDARCHIVE=prepped_${GRIDGFSE}_${INSTANCENAME}_${NCPU}.tar.gz
HINDCASTARCHIVE=prepped_${GRIDGFSE}_hc_${INSTANCENAME}_${NCPU}.tar.gz
...
# (e.g., the gfse of the queue to submit to, the addresses on the mailing list,
# etc)
#-------------------------------------------------------------------
#
# Copyright(C) 2024 Jason Fleming <jason.fleming@adcirc.live>
