...
INSTANCENAME=HSOFS_gfs_kitt_jgf_gfortran # "name" of this ASGS process
...
NCPU=8                 # number of compute CPUs for all simulations
NCPUCAPACITY=9999
NUMWRITERS=0
...
COLDSTARTDATE=2026050300
HOTORCOLD=hotstart
LASTSUBDIR=~/work/HSOFS_gfs_2026060600
#
# Scenario package
#
PERCENT=default
